                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="{{ asset('assets/vendor/img/food-item.jpg')}}" class="img-fluid rounded" alt="Image">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row g-4 fruite">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded" style="width: 100px; height: 100px;">
                                        <img src="{{ asset('assets/vendor/img/featur-1.jpg')}}" class="img-fluid rounded" alt="Image">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded" style="width: 100px; height: 100px;">
                                        <img src="{{ asset('assets/vendor/img/featur-2.jpg')}}" class="img-fluid rounded" alt="">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded" style="width: 100px; height: 100px;">
                                        <img src="{{ asset('assets/vendor/img/featur-3.jpg')}}" class="img-fluid rounded" alt="">
                                    </div>
                                    <div>
                            ...
                            <div class="col-lg-12">
                                <div class="position-relative">
                                    <img src="{{ asset('assets/vendor/img/banner-dog.png')}}" class="img-fluid w-100 rounded" alt="">
                    ...
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="{{ asset('assets/vendor/img/featur-1.jpg')}}" class="img-fluid w-100 rounded-top" alt="">
                            </div>
