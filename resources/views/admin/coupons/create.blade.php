...
@section('content')
                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form method="POST" action="{{ route('admin.coupon.store') }}">
                        ...
                        <div id="coupon-fields">
                            <div class="row mb-3 coupon-row">
                                <label class="col-sm-2 col-form-label">Code:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="codes[]" required>
                                </div>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center mb-3">
                            <button type="button" class="btn btn-secondary" id="add-coupon" style="font-size: 10px; padding: 5px 10px; background-color: grey;">Add Another Code</button>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control" id="max_discount" name="max_discount" value="{{ old('max_discount') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control" id="min_order_value" name="min_order_value" value="{{ old('min_order_value') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="{{ route('admin.coupon.list') }}" class="btn btn-primary ml-2" style="background-color: yellow;">Back to list</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        document.getElementById('add-coupon').addEventListener('click', function() {
            ...
            newCouponRow.className = 'row mb-3 coupon-row';
            ...
            `;
            couponFields.appendChild(newCouponRow);
        });
    </script>
@endsection
