...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="new_full_name" name="full_name" value="{{ old('full_name') }}">
</div>
<div class="form-group">
    <label for="new_phone_number" style="font-weight: bold;">Phone Number</label>
    <input type="text" class="form-control" id="new_phone_number" name="phone_number" value="{{ old('phone_number') }}">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="new_address_line_1" name="address_line_1" value="{{ old('address_line_1') }}">
</div>
<div class="form-group">
